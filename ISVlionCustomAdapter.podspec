Pod::Spec.new do |s|
    ...
    s.dependency 'MentaBaseGlobal',         '~> 1.0.24'
    s.dependency 'MentaMediationGlobal',    '~> 1.0.24'
    s.dependency 'MentaVlionGlobal',        '~> 1.0.24'
    s.dependency 'MentaVlionGlobalAdapter', '~> 1.0.24'
